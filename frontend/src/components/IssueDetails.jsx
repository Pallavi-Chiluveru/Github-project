...
export default function IssueDetails() {
  ...
  const tabs = [
    ...
    { id: 'issues', icon: CircleDot, label: 'Issues', count: 1, active: true },
           ...
           <div className="space-y-6">
              <div className="space-y-2 pb-6 border-b border-[#30363d]">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Assignees</h4>
                    <Settings className="h-4 w-4 text-[#8b949e] hover:text-[#f0f6fc] cursor-pointer" />
                 </div>
                 <p className="text-xs text-[#8b949e]">No one—<span className="text-[#4493f8] cursor-pointer hover:underline">assign yourself</span></p>
              </div>

              <div className="space-y-2 pb-6 border-b border-[#30363d]">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Labels</h4>
                    <Settings className="h-4 w-4 text-[#8b949e] hover:text-[#f0f6fc] cursor-pointer" />
                 </div>
                 <p className="text-xs text-[#8b949e]">No labels</p>
              </div>

              <div className="space-y-2 pb-6 border-b border-[#30363d]">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Projects</h4>
                    <Settings className="h-4 w-4 text-[#8b949e] hover:text-[#f0f6fc] cursor-pointer" />
                 </div>
                 <p className="text-xs text-[#8b949e]">No projects</p>
              </div>

              <div className="space-y-2 pb-6 border-b border-[#30363d]">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Milestone</h4>
                    <Settings className="h-4 w-4 text-[#8b949e] hover:text-[#f0f6fc] cursor-pointer" />
                 </div>
                 <p className="text-xs text-[#8b949e]">No milestone</p>
              </div>

              <div className="space-y-2 pb-6 border-b border-[#30363d]">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Relationships</h4>
                    <Settings className="h-4 w-4 text-[#8b949e] hover:text-[#f0f6fc] cursor-pointer" />
                 </div>
                 <p className="text-xs text-[#8b949e]">None yet</p>
              </div>

              <div className="space-y-3 pb-6 border-b border-[#30363d]">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Development</h4>
                    <Settings className="h-4 w-4 text-[#8b949e] hover:text-[#f0f6fc] cursor-pointer" />
                 </div>
                 <p className="text-xs text-[#4493f8] cursor-pointer hover:underline">Create a branch for this issue</p>
                 <p className="text-xs text-[#8b949e]">or link a pull request.</p>
              </div>

              <div className="space-y-3">
                 <div className="flex items-center justify-between">
                    <h4 className="text-xs font-semibold text-[#8b949e]">Notifications</h4>
                    <span className="text-[10px] text-[#8b949e] hover:text-[#4493f8] cursor-pointer">Customize</span>
                 </div>
                 <button className="flex w-full items-center justify-center gap-2 rounded-md border border-[#30363d] bg-[#21262d] py-1.5 text-xs font-semibold text-[#f0f6fc] hover:bg-[#30363d]">
                    <Bell className="h-4 w-4" /> Subscribe
                 </button>
                 <p className="text-[11px] text-[#8b949e]">You’re not receiving notifications from this thread.</p>
              </div>
           </div>
        </div>
      </div>
