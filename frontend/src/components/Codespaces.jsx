      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="flex flex-wrap items-center justify-between gap-6 mb-10 border-b border-[#30363d] pb-8">
           ...
           <div className="flex items-center gap-3">
              <button className="flex items-center gap-2 rounded-lg border border-[#30363d] bg-[#21262d] px-4 py-2 text-sm font-semibold text-[#f0f6fc] hover:bg-[#30363d] transition-all">
